...
基于现代前端技术栈构建的个人化 Notion 应用，提供类似 Notion 的文档编辑和管理功能。核心特点包括富文本编辑、主题色切换、国际化支持、用户认证、实时数据同步、文件上传、响应式设计等。
...
- 🌙 **主题色切换**：支持亮色和深色主题切换
- 🌐 **国际化支持**：多语言翻译支持（中、英、繁体已经上线，还有些文案在查漏补缺）
- 🔍 **文档搜索**：快速搜索和定位文档
